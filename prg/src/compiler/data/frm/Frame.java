...
public class Frame implements Loggable {
	...
	public Map<Integer, Long> tmpVarsToOffset = new HashMap<Integer, Long>();
	...
	public Long getTmpVarsOffset() {
//		System.out.print("LOC VARS:");
//		System.out.println(this.locVarsSize);
		return -(this.locVarsSize + 16 + this.tmpVarsSize);
	}
